...
let newCards = '';
const months = [{num:'12', short:'dec'}, {num:'11', short:'nov'}, {num:'10', short:'oct'}];
months.forEach(m => {
    newCards += `
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <h3>2025年${m.num}月 DMP 節目流量統計報表</h3>
                        <p>以 First-Party DMP 資料庫為基礎，分析各售票節目的 Page View 瀏覽量與排行。</p>
                    </div>
                    <div class="card-meta">
                        <span class="badge">Page Views</span>
                        <a href="A_DMP_PageView_Report_2025-${m.num}.html" class="btn-link"
...
const splitPoint = 'A_DMP_PageView_Report_2026-01.html" class="btn-link"\r\n                            style="background-color: #a78bfa; color: #fff;">\r\n                            查看報表\r\n                            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor">\r\n                                <path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\"\r\n                                    d=\"M14 5l7 7m0 0l-7 7m7-7H3\" />\r\n                            </svg>\r\n                        </a>\r\n                    </div>\r\n                </div>';
