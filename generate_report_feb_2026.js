...
async function generateReport() {
    try {
        ...
        console.log("Fetching data for 2026-02...");
        ...
        if (dates.length > 0) {
            ...
            // Fallback title if no data but we know it's Feb 2026 context
            fileTitle = "2026年02月 分析報表";
            dateTitle = "2026年02月 分析報表 (A系統)";
        }
...
<head>
    ...
    <style>
        ...
        /* 銷售排行表：節目名稱欄允許換行，避免表格被撐寬而讓外層 .table-container 跑出水平拉桿 */
        .table-container.no-hscroll { overflow-x: visible; }
        #topEventsTable td:nth-child(2), #topEventsTable th:nth-child(2),
        #topTicketsEventsTable td:nth-child(2), #topTicketsEventsTable th:nth-child(2) {
            white-space: normal;
