...
async function generateReport() {
    try {
        ...
        const TARGET = '2026 7-ELEVEN高雄櫻花季 SAKURA FESTIVAL';
        ...
        // Fetch Azure cloud cost for sale launch days (2025-12-23 & 2025-12-24)
...
<head>
    ...
    <title>2026 7-ELEVEN 高雄櫻花季 SAKURA FESTIVAL - 專案分析報表</title>
...
<div class="container">
    <header>
        <div>
            <div class="logo-text">🌸 2026 高雄櫻花季</div>
            <div class="logo-sub">7-ELEVEN 高雄櫻花季 SAKURA FESTIVAL 專案銷售分析報表</div>
        </div>
        <div class="meta">報表生成: ${reportTime}<br>銷售紀錄: ${data.length.toLocaleString()} 筆<br>節目代碼: B0AJKPPD</div>
    </header>
    ...
    <!-- Peak Analysis -->
    <div class="chart-card" style="min-height:0">
        <h3>開賣尖峰時段分析 (2025-12-23 12:00 – 13:00)</h3>
    ...
    <!-- Cloud Cost Analysis -->
    <div class="chart-card" style="min-height:0">
        <h3>☁️ 開賣日雲端費用成本 (2025-12-23 & 12-24)</h3>
        <table id="costTable">
            <thead>
                <tr>
                    <th>日期</th>
...
function init() {
    ...
    const allDates = Array.from(allDatesSet).sort().filter(d => d >= '2025-12-23' && d <= '2026-02-01');
    ...
    new Chart(document.getElementById('viewChart'), {
        ...
        options: {
            ...
            scales: {
                ...
                y: { grid: { color: 'rgba(255,255,255,0.05)' }, ticks: { color: '#f472b6', callback: v => v >= 1000 ? v/1000+'k' : v }, beginAtZero: true }
            }
        }
    });
    ...
    // Show Cards
    const shows = [
        { date: '2026-03-13', label: '3/13 (五) Day 1' },
        { date: '2026-03-14', label: '3/14 (六) Day 2' },
        { date: '2026-03-15', label: '3/15 (日) Day 3' }
    ];
    ...
    const sessionShows = [
        { date: '2026-03-13', label: '3/13 (五) Day 1', color: '#f472b6' },
        { date: '2026-03-14', label: '3/14 (六) Day 2', color: '#c084fc' },
        { date: '2026-03-15', label: '3/15 (日) Day 3', color: '#fb923c' }
    ];
    ...
    // Peak Analysis - 2025-12-23 12:00-13:00
    const peakDate = '2025-12-23';
    const peakStats = {};
    for (let m = 0; m < 60; m++) {
    ...
    costData.forEach(d => {
        ...
        tr.innerHTML = \`<td style="font-weight:600; color:var(--accent-color);">\${d.date}</td>
            ...
            <td style="color:#94a3b8; font-size:0.9em;">\${d.activity}</td>
            <td style="color:#64748b; font-size:0.85em;">\${d.notes}</td>\`;
...
<\/script>
        ...
        const fileName = 'A_KaohsiungSakuraFestival_2026.html';
