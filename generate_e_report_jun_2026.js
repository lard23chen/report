...
async function generateReport() {
    try {
        ...
        console.log("Fetching data for 2026-06...");
        const data = await collection.find({ "交易時間": { $regex: "^2026-06" } }).toArray();
        ...
        let fileTitle = "2026年06月 分析報表";
        let dateTitle = "2026年06月 分析報表 (E系統)";
...
" onmouseover="this.style.transform='translateY(-3px)'; this.style.boxShadow='0 6px 20px rgba(216, 27, 96, 0.5)';" 
   onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 15px rgba(216, 27, 96, 0.4)';">
    ...
    回首頁
        ...
        const fileName = `E_Qware_Revenue_Report_2026年06月_分析報表.html`;
