...
async function generateReport() {
    try {
        ...
        console.log("Fetching and aggregating April 2026 data...");
        ...
        const dateTitle = "2026年04月 分析報表 (A系統)";
        let logoBase64 = '';
        try {
...
</body></html>`.replace(/2026年02月/g, "2026年04月");

        const fileName = `A_Qware_Revenue_Report_2026年04月_分析報表.html`;
