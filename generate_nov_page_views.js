...
async function main() {
    ...
    try {
        ...
        const startDt = new Date("2025-10-31T16:00:00.000Z"); // 台灣時間 2025-11-01 00:00
        const endDt = new Date("2025-11-30T16:00:00.000Z");   // 台灣時間 2025-12-01 00:00
        ...
        // 建立 dmp_details_nov 資料夾
        const detailsDir = path.join(__dirname, 'dmp_details_nov');
        ...
        // 產生所有日期的陣列，讓趨勢圖可以補 0
        const allDays = [];
        let curr = new Date("2025-11-01T00:00:00.000Z");
        while (curr <= new Date("2025-11-30T00:00:00.000Z")) {
        ...
        validPrograms.forEach((prog, idx) => {
            const safeName = "Nov_Detail_" + String(idx).padStart(3, '0');
            const detailFileName = `A_DMP_PageView_${safeName}.html`;
            prog.detailLink = `dmp_details_nov/${detailFileName}`;
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <p>2025年11月 每日流量趨勢 (總瀏覽量: ${prog.totalViews.toLocaleString()})</p>
        </div>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>DMP 11月份 節目 Page View 統計</title>
    <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/chartjs-plugin-datalabels@2"></script>
    <link href="https://fonts.googleapis.com/css2?family=Outfit:wght@300;400;600;800&family=Noto+Sans+TC:wght@300;400;500;700&display=swap" rel="stylesheet">
    <style>
...
<body>
    ...
    <script>
        ...
        function exportRawData() {
            ...
            link.setAttribute('download', 'DMP_PageView_RawData_2025-11.csv');
        ...
        const outPath = path.join(__dirname, 'A_DMP_PageView_Report_2025-11.html');
