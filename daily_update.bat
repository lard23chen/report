...
echo Running generate_f_mem_blacklist_query.js...
"D:\nodejs\node.exe" generate_f_mem_blacklist_query.js >> daily_log.txt 2>&1
if errorlevel 1 set FAILED_STEPS=%FAILED_STEPS%generate_f_mem_blacklist_query.js;
